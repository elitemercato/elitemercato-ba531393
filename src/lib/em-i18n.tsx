...
export const T = {
  ar: {
    brand: "إليت ميركاتو", tagline: "منظومة رياضية وتكنولوجية متكاملة",
    ...
    feat3Title: "تغطية وطنية شاملة", feat3Desc: "من الشمال للجنوب، ومن الشرق إلى الغرب… الكل هنا",
    heroBadge: "الجيل القادم من كشف المواهب الجزائرية",
    navJoin: "انضم إلينا", joinTitle: "انضم إلى إليت ميركاتو", joinSub: "اختر نوع حسابك للبدء",
    ...
    rememberMe: "تذكرني",
    forgotTitle: "نسيت كلمة المرور؟", forgotSub: "أدخل بريدك لإرسال رابط إعادة التعيين",
    sendResetLink: "إرسال رابط الاستعادة",
    resetEmailSent: "تم إرسال الرابط", resetEmailSentDesc: "تفقد بريدك واتبع التعليمات لإعادة تعيين كلمة المرور.",
    resetTitle: "تعيين كلمة مرور جديدة", resetSub: "اختر كلمة مرور قوية للحفاظ على حسابك",
    ...
    featuresTitle: "لماذا إليت ميركاتو؟", featuresSubtitle: "منظومة متكاملة تجمع الكشف الذكي بالحماية القانونية والخدمات الميدانية في منصة واحدة.",
  ...
  en: {
    ...
    forgotTitle: "Forgot password?", forgotSub: "Enter your email to receive a reset link",
    sendResetLink: "Send reset link",
    resetEmailSent: "Reset link sent", resetEmailSentDesc: "Check your inbox and follow the instructions to reset your password.",
    resetTitle: "Set a new password", resetSub: "Choose a strong password to secure your account",
  ...
  fr: {
    ...
    forgotTitle: "Mot de passe oublié ?", forgotSub: "Entrez votre email pour recevoir un lien de réinitialisation",
    sendResetLink: "Envoyer le lien",
    resetEmailSent: "Lien envoyé", resetEmailSentDesc: "Consultez votre boîte mail et suivez les instructions pour réinitialiser votre mot de passe.",
    resetTitle: "Nouveau mot de passe", resetSub: "Choisissez un mot de passe sécurisé",
    newPassword: "Nouveau mot de passe", updatePassword: "Mettre à jour",
