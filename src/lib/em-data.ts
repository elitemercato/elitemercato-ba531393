...
export const PLAYERS: Player[] = [
  ...
  { id: 7, name: "أيوب ڨلومة", nameEn: "Ayoub Guellouma", nameFr: "Ayoub Guellouma", position: "RB", club: "اتحاد البليدة", clubEn: "USM Blida", clubFr: "USM Blida", wilaya: "البليدة", wilayaEn: "Blida", wilayaFr: "Blida", value: 14000000, age: 23, rating: 87, goals: 2, assists: 8, img: "AG", photo: ayoubPhoto, foot: "R", height: 180, weight: 75, nationality: "DZ" },
